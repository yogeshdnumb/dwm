...
#else
static const char *fonts[]          = { "JetBrainsMono Nerd Font:style:medium:size=10:antialias=true:hinting=true", "monospace:size=10" };
...
static char normfloatcolor[]             = "#ff300f";
...
#if RENAMED_SCRATCHPADS_PATCH
static const char *scratchpadcmd[] = {"s", term, "-T", "spterm", NULL};
...
static const Key keys[] = {
	...
	{ MODKEY,            		    XK_space, spawn,          sh("~/.config/rofi/scripts/launcher_t2")},
	{ MODKEY,                       XK_w,      spawn,          sh("librewolf")},
	{ MODKEY,                       XK_s,      spawn,          sh("vscodium")},
	...
	{ MODKEY,                       XK_r,      spawn,          sh(term " -e nvim")},
	...
	{ MODKEY,             			XK_Delete,     spawn,          sh("killall xinit") },
	{ MODKEY,             			XK_F5,     spawn,          sh("systemctl suspend") },
	{ 0,                            XF86XK_AudioRaiseVolume,   spawn,     sh("wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 5%+ && kill -35 $(pidof dwmblocks)") },
	{ 0,                            XF86XK_AudioLowerVolume,   spawn,     sh("wpctl set-volume -l 1.0 @DEFAULT_AUDIO_SINK@ 5%- && kill -35 $(pidof dwmblocks)") },
	{ 0,                            XF86XK_AudioMute,      	   spawn,     sh("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle && kill -35 $(pidof dwmblocks)") },
	{ MODKEY,             			    XF86XK_RFKill,spawn,       sh("wifi toggle") },
	{ 0,             			    XF86XK_MonBrightnessUp,spawn,       sh("light -A 5") },
	{ 0,             			    XF86XK_MonBrightnessDown,spawn,       sh("light -U 5") },
	#if KEYMODES_PATCH
	...
	{ MODKEY,           XK_Tab,      setscratch,             {.v = scratchpadcmd } },
	{ MODKEY|ShiftMask,             XK_Tab,      removescratch,          {.v = scratchpadcmd } },
	#elif SCRATCHPADS_PATCH
...
static const Button buttons[] = {
	...
	{ ClkClientWin,         MODKEY,              Button1,        movemouse,    {.i = 1} },
	{ ClkClientWin,         MODKEY|Mod1Mask,              Button1,        placemouse,    {.i = 1} },
	#else
	...
	{ ClkClientWin,         MODKEY|ShiftMask|ControlMask,    Button1,        dragcfact,      {0} },
